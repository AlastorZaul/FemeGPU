...
export class GpuDataService {
  ...
  private apiUrl = 'http://ai-manager-tu1.ia1.metier.devpass.sf.intra.laposte.fr/api'; // J'ai supposé le protocole http et un chemin /api
  ...
  public gpuData$: Observable<Cluster[]> = timer(0, 5000).pipe(
    ...
    switchMap(() =>
      ...
      this.http.get<Cluster[]>(`${this.apiUrl}/clusters`).pipe(
